...
class TestTfidfDictionaryCreator(AbstractTestDictionaryCreator):
    ...
    def test__train_tfidf_based_model(self):
        ...
        self.assertEqual({
            'eng': {'1.2 1': {'earth': (1.0, None)},
                    '4.9.6 1': {'and': (0.447213595499958, None),
                                'heaven': (0.894427190999916, None)}},
            'fra': {'1.2.3 1': {'avec': (0.10540925533894598, None),
                                'eaux': (0.8432740427115678, None),
                                'les': (0.5270462766947299, None)},
                    '8.3.3.2 6': {'ténèbres': (1.0, None)}}
